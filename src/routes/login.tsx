    ...
    <div className="news-container py-16 max-w-md">
      <div className="bg-card rounded-lg border border-border p-6 shadow-sm">
        ...
        <button
          ...
          disabled={busy}
          className="w-full flex items-center justify-center gap-2 border border-border rounded-md py-2.5 text-sm font-medium hover:bg-secondary transition-colors mb-4 disabled:opacity-60"
        >
